...
const UpdateWasherModal = ({updateflag, setUpdateFlag, handleClose, onUpdate, updateId, initData}) => {
  const {
    control,
    handleSubmit,
    formState: { errors },
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <Typography sx={{ mb: 3 }}>
          Please input the necessary informations for updating a washer.
        </Typography>
...
export default UpdateWasherModal;